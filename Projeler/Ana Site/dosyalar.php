...
<a onclick="history.back();"  id="GeriBtn"><i class="fa-solid fa-backward"></i> Geri Dön</a>


<div class="card die-card">
    <p>Giriş Yapmadan Bu Sayfaya Giremezsiniz</p>
    <p>Girş Yapmak İçin</p>
    <p><a href="login.php">Tıklayın</a></p>
</div>
...
<div id="navbar" class="header">
    ...
    ?>
        ...
        <form name="yukle" enctype="multipart/form-data">
            ...
            <span class="drop-title">Fotoğraflarınızı Seçin</span>
            <input type="file" id="images" name="selectFile[]" accept="image/*" required multiple>
        ...
        <div class="card dosya-card mt-5">
            <div class="row">
                <?php
